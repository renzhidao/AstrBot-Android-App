        ...
        child: ListView(
          children: [
            ...
            ListTile(
              ...
              title: const Text('前往 AstrBot 页面'),
              subtitle: const Text('返回 AstrBot 主页并刷新内容'),
              onTap: () {
                // 跳转到主页，保持导航栏
                Get.offAllNamed('/');
            ...
            ListTile(
              ...
              subtitle: Obx(() => Text(
                homeController.napCatWebUiToken.value.isEmpty 
                  ? '未获取到 Token' 
                  : homeController.napCatWebUiToken.value,
                style: TextStyle(
              ...
              onTap: () {
                // 复制 Token 到剪贴板
                if (homeController.napCatWebUiToken.value.isNotEmpty) {
                  Clipboard.setData(ClipboardData(text: homeController.napCatWebUiToken.value));
                  Get.snackbar(
                    '已复制',
                    'Token 已复制到剪贴板',
                    snackPosition: SnackPosition.BOTTOM,
